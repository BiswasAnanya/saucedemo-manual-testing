...
- **Checkout flow state-validation bypass** - observed at 4 separate entry points (Shopping Cart, Checkout Step One, Step Two, and Complete), indicating the application does not consistently enforce checkout sequence prerequisites.
